            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.songs.update', ['song' => $song->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" name="name" id="song-name" class="form-control no-highlight"
                                        placeholder="{{ __('song_name') }}" value="{{ $song->name }}">
                                        ...
                                        <select class="song-authors-select2 form-control" id="song-authors"
                                            ...
                                            @foreach ($authors as $author)
                                                <option value="{{ $author->id }}"
                                                    @if (in_array($author->id, $song->authors->pluck('id')->toArray())) selected @endif>
                                                    {{ $author->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <div class="c-select2">
                                        <select class="song-album-select2 form-control" id="song-album" name="album_id">
                                            @forelse ($song->authors as $songAuthor)
                                                @forelse ($songAuthor->albums as $album)
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <input type="file" name="song" id="song-path" class="form-control-file"
                                        accept="audio/*">
                                    <audio src="{{ asset($song->path) }}" id="pre-listening" controls></audio>
                                    <input type="hidden" name="durations" id="durations" value="{{ $song->durations }}">
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12 position-relative">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <div class="edit-song-thumbnail-preview ml-3">
