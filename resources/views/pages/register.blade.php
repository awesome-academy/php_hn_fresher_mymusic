                ...
                <div class="register-form-layout">
                    ...
                    <div class="register-form">
                        <form>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control form-control-lg" placeholder="{{ __('Enter your email here') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" name="first_name" id="first_name" class="form-control form-control-lg" placeholder="{{ __('Enter your first name here') }}">
                                    <small class="text-danger"></small>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" name="last_name" id="last_name" class="form-control form-control-lg" placeholder="{{ __('Enter your last name here') }}">
                                    <small class="text-danger"></small>
                                </div>
                            </div>
                            <div class="form-row">
                        ...
                        <p class="text-center mt-3">
                            {{ __('Do you have an account?') }} <a href="#"> {{ __('Login now') }} </a>
                        </p>
                    </div>
                </div>
            </div>
